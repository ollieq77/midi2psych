...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/,
    ...
    g_hMainWnd = CreateWindowEx(0,
        "MIDI2PsychConverter", "MIDI to Psych Engine Converter V2.0",
        WS_OVERLAPPEDWINDOW & ~WS_THICKFRAME & ~WS_MAXIMIZEBOX,
        CW_USEDEFAULT, CW_USEDEFAULT, 900, 1040,
        NULL, NULL, hInstance, NULL);

    ShowWindow(g_hMainWnd, nCmdShow);
    UpdateWindow(g_hMainWnd);

    // Ctrl+Enter triggers Convert from anywhere in the window.
    ACCEL accels[] = { { FCONTROL | FVIRTKEY, VK_RETURN, ID_BTN_CONVERT } };
